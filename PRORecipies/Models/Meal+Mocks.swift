...
extension Categories {
    static private var dummyCategory = Category(
        id: "1",
        name: "Beef",
        thumbnailLink: "https://www.themealdb.com/images/category/beef.png",
        description: """
...
extension Meals {
    static private var dummyMeal = Meal(
        id: "52768",
    ...
    static public var dummyData1 = [
        Meal(id: "5943953",
             ...
             area: "British",
             instructions: """
             Preheat the oven to 200C180C Fan. Gas 6. Put the biscuits in a large re-sealable freezer
             bag and bash with a rolling pin into fine crumbs. Melt the butter in a small pan,
        ...
        Meal(id: "34022049",
             ...
             area: "British",
             instructions: """
             Preheat the oven to 200C180C Fan. Gas 6. Put the biscuits in a large re-sealable
             freezer bag and bash with a rolling pin into fine crumbs.
             Melt the butter in a small pan, then add the biscuit crumbs and stir until coated with butter.
             """,
             youTubeLink: "https://www.youtube.com/watch?v=rp8Slv4INLk",
             tags: ["butter", "softened"],
